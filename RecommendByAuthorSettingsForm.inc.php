...
/**
 * @file plugins/generic/recommendByAuthor/RecommendByAuthorSettingsForm.inc.php
 *
...
class RecommendByAuthorSettingsForm extends Form
{
    ...
    public function fetch($request, $template = null, $display = false)
    {
        ...
        $templateMgr->assign([
            ...
            'orderByOptions' => [
                RecommendByAuthorStore::ORDER_BY_METRIC => 'plugins.generic.recommendByAuthor.settings.orderBy.metric',
                RecommendByAuthorStore::ORDER_BY_DATE => 'plugins.generic.recommendByAuthor.settings.orderBy.date',
            ],
    ...
    public function execute(...$functionArgs)
    {
        ...
        $orderBy = $this->getData('orderBy') === RecommendByAuthorStore::ORDER_BY_DATE
            ? RecommendByAuthorStore::ORDER_BY_DATE
            : RecommendByAuthorStore::ORDER_BY_METRIC;
