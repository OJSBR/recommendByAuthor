...
/**
 * @file plugins/generic/recommendByAuthor/classes/RecommendByAuthorKey.inc.php
 *
 ...
 *
 * @class RecommendByAuthorKey
 *
 * @brief Turns an author into the keys under which their articles are found.
 */


// Normalizer comes from ext-intl; 3.3 has no autoloader for plugin classes,
// so there is no namespace to import it into.
